            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                <div class="kt-grid">
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                        <form class="mt-2"  action="{{route('cancel_shop')}}" accept-charset="UTF-8"  method="POST" enctype="multipart/form-data" >
                            @csrf
                            <input type="hidden" autocomplete="OFF" name="shop_id" value="{{$shop->id}}" class="form-control input-sm" required />
