@extends('dashboard.layouts.app',['title'=>'Contact'])
@section('style')
    ...
    <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
            <ul class="kt-menu__nav ">
                ...
                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--active" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="{{route('contact')}}" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon">
                           <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
...
<!-- begin:: Content -->
@section('Content')
    <div class="kt-negative-spacing--6"></div>
    ...
    <!-- end:: Hero -->
    <div class="kt-negative-spacing--4"></div>
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header" style="background-color: #478fcd ">
                        ...
                        <div class="card-body" style="background-color: lightgray;">
                            <section id="contact">
                                <div class="container">
                                    <h3 class="text-center text-uppercase"><img
                                            src="{{asset('images/dashboard/yankadi2.png')}}" alt="PayDunya Event"
                                            style="height: 150px;"></h3>
                                    <p class="text-center w-75 m-auto lead">YANKADI-SHOP est un portail qui offre une façon simple, amusante et pratique d’acheter et de vendre des biens ou des services. On peut y trouver un appartement, un emploi, une voiture, un smartphone, une nounou et bien d’autres choses. Chaque jour, plusieurs centaines d’annonces sont publiées sur le site.
                                    </p>
                                    <div class="row justify-content-center">
                                        <div class="col-sm-12 col-md-6 col-lg-3 my-5">
                                            <div class="card border-0">
                                                <div class="card-body text-center">
                                                    <i class="fa fa-phone fa-5x mb-3 text-primary"
                                                       aria-hidden="true"></i>
                                                    <h4 class="text-uppercase mb-5 text-primary">Appelez-nous</h4>
                                                    <p>Tel:(+221) 78 214 73 31</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6 col-lg-3 my-5">
                                            <div class="card border-0">
                                                <div class="card-body text-center">
                                                    <i class="fa fa-building fa-5x mb-3 text-primary"
                                                       aria-hidden="true"></i>
                                                    <h4 class="text-uppercase mb-5
                     text-primary">Adresse</h4>
                                                    <address>Bamako mali.
                                                    </address>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-3 my-5">
                                            <div class="card border-0">
                                                <div class="card-body text-center">
                                                    <i class="fa fa-envelope fa-5x mb-3 text-primary"
                                                       aria-hidden="true"></i>
                                                    <h4 class="text-uppercase mb-5 text-primary">Adresse mail</h4>
                                                    <p>Ventes@yankadi.com</p>
                                                </div>
                                            </div>
                                        </div>
                                        <p class="text-center w-75 m-auto">
              <span class="text-uppercase">ou <br>
             <strong>Contactez-nous via nos divers réseaux sociaux</strong></span><br>
                                            ...
                                            <a href="#" target="_blank"
                                               class="btn btn-primary mt-1"><i class="fab fa-facebook-f pr-2"></i>
                                                Facebook</a>
                                            <a href="#" target="_blank"
                                               class="btn btn-primary mt-1"><i class="fab fa-linkedin pr-2"></i> LinkedIn</a>
                                            <a href="#" target="_blank"
                                               class="btn text-white"
                                               style=" background: radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%,#d6249f 60%,#285AEB 90%);"><i
                                                    class="fab fa-instagram pr-2 mt-1"></i> Instagram</a>
                                            <a href="#" target="_blank"
                                               class="btn btn-danger mt-1"><i class="fab fa-youtube pr-2"></i> YouTube</a>
                                        </p>
