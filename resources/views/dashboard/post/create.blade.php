@extends('dashboard.layouts.app',['title'=>'Ajout annonce'])
@section('style')
            ...
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__group" id="kt_subheader_search">
										<span class="kt-subheader__desc" id="kt_subheader_total">
											Entrer les détails du l'annonce et enregistrer </span>
                </div>
            </div>
            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                <div class="kt-grid">
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                        ...
                        <form class="mt-2"  action="{{route('post.store')}}" accept-charset="UTF-8"  method="POST" enctype="multipart/form-data" >
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('quantity') is-invalid @enderror" name="quantity" value="{{ old('quantity') }}"  placeholder="Entrer la quantité du produit">
                            </div>
                            @error('quantity')
                            <span class="alert alert-danger mt-1" role="alert">
                                    <strong>{{ $message }}</strong>
