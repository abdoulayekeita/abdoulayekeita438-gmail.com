@extends('dashboard.layouts.app',['title'=>'Modification annonce'])
@section('style')
                ...
                <div class="kt-grid">
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                        ...
                        <form class="mt-2"  action="{{route('post.update',$post)}}" accept-charset="UTF-8"  method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                <label>Prix</label>
                                <input type="number" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price') ?? $post->product->price}}" >
                            </div>
                            @error('price')
                            <span class="alert alert-danger mt-1" role="alert">
                                    <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('quantity') is-invalid @enderror" name="quantity" value="{{ old('quantity') ?? $post->product->quantity}}" >
                            </div>
                            @error('quantity')
                            <span class="alert alert-danger mt-1" role="alert">
                                    <strong>{{ $message }}</strong>
